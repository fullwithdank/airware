...
void SaveCallbk()
{
	...
	{
	case 0:
		GUI.SaveWindowState(&Menu::Window, "AstrixLegit.cfg");
		break;
	case 1:
		GUI.SaveWindowState(&Menu::Window, "AstrixLegit2.cfg");
		break;
	case 2:
		GUI.SaveWindowState(&Menu::Window, "AstrixHVH1.cfg");
		break;
	case 3:
		GUI.SaveWindowState(&Menu::Window, "AstrixHVH2.cfg");
		break;
	case 4:
		GUI.SaveWindowState(&Menu::Window, "AstrixHVH3.cfg");
		break;
	case 5:
		GUI.SaveWindowState(&Menu::Window, "AstrixNSHvH.cfg");
		break;
	}
}
...
void LoadCallbk()
{
	...
	{
	case 0:
		GUI.LoadWindowState(&Menu::Window, "AstrixLegit.cfg");
		break;
	case 1:
		GUI.LoadWindowState(&Menu::Window, "AstrixLegit2.cfg");
		break;
	case 2:
		GUI.LoadWindowState(&Menu::Window, "AstrixHVH1.cfg");
		break;
	case 3:
		GUI.LoadWindowState(&Menu::Window, "AstrixHVH2.cfg");
		break;
	case 4:
		GUI.LoadWindowState(&Menu::Window, "AstrixHVH3.cfg");
		break;
	case 5:
		GUI.LoadWindowState(&Menu::Window, "AstrixNSHvH.cfg");
		break;
	}
}
...
#pragma region Aimbot
	...
	AimbotGroup.SetSize(240, 383);//idk what spacing you use but this is 20 from the fakelag.. 422 is where fakelag is
	...
	AimbotSelection.AddItem("Crosshair");
	...
	AimbotHitscan.AddItem("Nothing");
	AimbotHitscan.AddItem("Head, Chest, Stomach");
	AimbotHitscan.AddItem("Head, Neck, Body, Pelvis");
	AimbotHitscan.AddItem("Head, Body, Pelvis, Legs, Arms");
	AimbotGroup.PlaceLabledControl("", this, &AimbotHitscan);
	...
	AimbotPointscale.SetBoundaries(0, 5); // 0 is center 5 is very top of head good for backtwards btw.
	AimbotPointscale.SetValue(3);
	...
	AutoRevolver.SetFileId("acc_arevolver");
	...
	AimbotPSilentAim.SetFileId("aim_psilent");
	AimbotGroup.PlaceLabledControl("Perfect Silent Aim", this, &AimbotPSilentAim);
...
#pragma region Accuracy
	...
	AccuracyGroup.SetSize(240, 295 - 65);
...
//	AccuracyGroup.PlaceLabledControl("Auto Crouch +  Stop", this, &AccuracyAutoCrouch);
	...
	LBYCorrection.SetFileId("acc_pitchcorrection");
	AccuracyGroup.PlaceLabledControl("Anti-Aim Correction", this, &LBYCorrection);
	...
	AimbotResolver.AddItem("Spread");
	AimbotResolver.AddItem("NoSpread");
	AccuracyGroup.PlaceLabledControl("", this, &AimbotResolver);

/*	Baim1.SetFileId("acc_aaa");
	AccuracyGroup.PlaceLabledControl("Baim if", this, &Baim1);

	Baim.SetFileId("acc_aaa");
	Baim.AddItem("Off");
	Baim.AddItem("if Fake");
	Baim.AddItem("if Lethal");
	Baim.AddItem("if Fake, Air, Lethal");
	AccuracyGroup.PlaceLabledControl("", this, &Baim);*/
	...
	FakeLagFix.SetFileId("fakelagfix1"); // This is the fakelagfix 
	AccuracyGroup.PlaceLabledControl("Backtrack", this, &FakeLagFix);

	SomeShit1.SetFileId("someshit1"); // Space for Override
	AccuracyGroup.PlaceLabledControl("Override", this, &SomeShit1);

	SomeShit.SetFileId("someshit1"); // This is meme override with -180°
	AccuracyGroup.PlaceLabledControl("", this, &SomeShit);
...
#pragma region AntiAim
	...
	FakeYaw.AddItem("Off");
	FakeYaw.AddItem("Default");
	FakeYaw.AddItem("Default Opposite");
	...
	FakeYaw.AddItem("Sideways Jitter");
	...
	AntiAimYaw.AddItem("Default");
	AntiAimYaw.AddItem("Default Opposite");
	...
	AimbotManualAA1.SetFileId("aa_flip");
	AntiAimGroup.PlaceLabledControl("Flip Anti Aim", this, &AimbotManualAA1);

	AimbotManualAA.SetFileId("aa_lby1");
	AntiAimGroup.PlaceLabledControl("", this, &AimbotManualAA);

/*	LBYBreak.SetFileId("lby_breaker");
	AntiAimGroup.PlaceLabledControl("Break LBY", this, &LBYBreak);

	LBYBreakDelta.SetFileId("lby_breakerdelta");
	LBYBreakDelta.SetBoundaries(-180, 180);
	LBYBreakDelta.SetValue(0);
	AntiAimGroup.PlaceLabledControl("Break LBY Delta", this, &LBYBreakDelta);*/
...
/*	Testslide1.SetPosition(16+85+177,22);
	...
	AimbotGroup.PlaceLabledControl("Backtrack",this,&FakeLagFix);
...
#pragma region Options
	...
	OptionsArmor.SetFileId("opt_ammo");
	OptionsGroup.PlaceLabledControl("Ammo Bar", this, &OptionsArmor);
...
/*	OptionsGlow.SetFileId("opt_glow");
	...
	OptionsDMG.SetFileId("opt_dmgonenemy");
	OptionsGroup.PlaceLabledControl("Draw DMG on Enemy", this, &OptionsDMG);

	OptionsAimpoint.SetFileId("opt_aimpoint");
	OptionsGroup.PlaceLabledControl("Draw current Aimspot", this, &OptionsAimpoint);

//	OptionsOverrideFov.SetFileId("opt_aimpoint");
//	OptionsGroup.PlaceLabledControl("Override Fov while Scoped", this, &OptionsOverrideFov);
...
#pragma region models
	...
	ModelG.PlaceLabledControl("Opacity", this, &OptionsDroppedc1);

	OptionsDroppedc2.SetFileId("acc_opacityslider");
	OptionsDroppedc2.SetBoundaries(0, 100);
	OptionsDroppedc2.SetValue(100);
	ModelG.PlaceLabledControl("", this, &OptionsDroppedc2);
...
#pragma region Other
	...
	DrawBullets.SetFileId("otr_bullettracers");
	OtherGroup.PlaceLabledControl("Bullet Tracers", this, &DrawBullets);

	Nightmode.SetFileId("eff_night");
...
#pragma region Effects
	...
	FakeAngles1.SetFileId("aa_fakeangle1");
	FiltersGroup.PlaceLabledControl("Angle chams", this, &FakeAngles1);

	FakeAngles.SetFileId("aa_fakeangle");
	FakeAngles.AddItem("Off");
	FakeAngles.AddItem("Draw Fake");
	FakeAngles.AddItem("Draw LBY");
	FiltersGroup.PlaceLabledControl("", this, &FakeAngles);
	...
	AmbientSkybox.AddItem("Night 2");
	AmbientSkybox.AddItem("Nosky");
	...
	OtherCrosshair.AddItem("Wall");
	OtherCrosshair.AddItem("Damage");
	OtherCrosshair.AddItem("Wall + Damage");
...
#pragma region Other
	...
	OtherGroup.SetSize(240, 500);//500 is bottom js
...
#pragma endregion */
	...
	OtherGroup.PlaceLabledControl("Watermark", this, &Watermark); // Get famous with it.

	Zeusbot.SetFileId("otr_Zeusbot");
	OtherGroup.PlaceLabledControl("Zeusbot", this, &Zeusbot); // Zeusbot isnt even coded *meme*

	OtherAutoAccept.SetFileId("otr_autoaccept");
	OtherGroup.PlaceLabledControl("Auto Accept", this, &OtherAutoAccept);

	Logs.SetFileId("otr_logdamage");
	OtherGroup.PlaceLabledControl("Log Damage dealt", this, &Logs);

	LogsBuy.SetFileId("otr_logbuys");
	OtherGroup.PlaceLabledControl("Log Purchases", this, &LogsBuy);

	OtherSlowMotion1.SetFileId("otr_slowmotionscperate");
	OtherGroup.PlaceLabledControl("Slow Motion", this, &OtherSlowMotion1);

	OtherSlowMotion.SetFileId("otr_slowmotionbutton");
	OtherGroup.PlaceLabledControl("", this, &OtherSlowMotion);

/*	KnifeGroup.SetPosition(16 + 85, 22 + 250 + 20 + 80 + 72);
	KnifeGroup.SetText("Knife Changer");
	KnifeGroup.SetSize(240, 80);
...
#pragma region Settings
	...
	OtherChatSpam.AddItem("Astrix");
	OtherChatSpam.AddItem("A S T R I X");
	...
	OtherClantag.AddItem("Astrix");
	OtherClantag.AddItem("gamesense");
	OtherClantag.AddItem("Time");
	OtherClantag.AddItem("Admin");
	OtherClantag.AddItem("[ADMIN]");
	OtherClantag.AddItem("Valve");
	OtherClantag.AddItem("[VIP]");
	OtherClantag.AddItem("finnensing");
	OtherClantag.AddItem("dun finnese");
	OtherClantag.AddItem("falschkopf");
	OtherClantag.AddItem("starplayer '");
	OtherClantag.AddItem("mr");
	FakeLagGroup.PlaceLabledControl("", this, &OtherClantag);

	EnableGloves.SetFileId("gloves_enable");
	FakeLagGroup.PlaceLabledControl("Enabled", this, &EnableGloves);
	...
	FakeLagGroup.PlaceLabledControl("Model", this, &GloveModel);
	...
	FakeLagGroup.PlaceLabledControl("Skin", this, &GloveSkin);
...
#pragma region Presets
	...
	ConfigBox.AddItem("Legit AA");
	ConfigBox.AddItem("HvH");
	ConfigBox.AddItem("Scout");
	ConfigBox.AddItem("Awp");
	...
	BuyBot.AddItem("AWP");
	BuyBot.AddItem("Auto Sniper and Duals");
	BuyBot.AddItem("SSG-08");
	...
	BuyBotGrenades.AddItem("Smoke, and HE");
	BuyBotGrenades.AddItem("Smoke, HE, and Fire");
	...
	BuyBotZeus.SetFileId("buybot_zeus");
	BuyBotGroup.PlaceLabledControl("Buy a Zeus", this, &BuyBotZeus);
...
#pragma region Knife
	...
	KnifeGroup.SetPosition(16 + 85, 11);
	KnifeGroup.SetText("Knife Changer");
	KnifeGroup.SetSize(240, 80);
	RegisterControl(&KnifeGroup);
...
#pragma region Snipers
	Snipergroup.SetPosition(16 + 85, 100);
...
#pragma region Rifles
	Riflegroup.SetPosition(16 + 85, 240);
//	Riflegroup.SetPosition(16 + 85, 250 - 68);
...
#pragma region Pistols
	...
	PistolGroup.SetPosition(279 + 85, 195);
...
#pragma region Skinsettings
	SkinsettingsGroup.SetPosition(16 + 85, 450);
	SkinsettingsGroup.SetText("Customization");
	SkinsettingsGroup.SetSize(250, 75);
	...
	KnifeName1.SetFileId("knife_name1");
	SkinsettingsGroup.PlaceLabledControl("Knife Name", this, &KnifeName1);

	KnifeName.SetFileId("knife_name");
	SkinsettingsGroup.PlaceLabledControl("", this, &KnifeName);

	SkinApply.SetText("Force Update");
	SkinApply.SetCallback(GlovesApplyCallbk);
	SkinApply.SetPosition(279 + 85, 445);
...
#pragma region Visual Colors
	...
	ControlGroup.SetText("Colors");
	ControlGroup.SetPosition(16 + 85, 220);
	ControlGroup.SetSize(240, 240);
	...
	ControlGroup.PlaceLabledControl("Glow Red", this, &GlowR);

	GlowG.SetFileId("GlowG");
	GlowG.SetBoundaries(0.f, 255.f);
	GlowG.SetValue(0.f);
	ControlGroup.PlaceLabledControl("Glow Green", this, &GlowG);

	GlowB.SetFileId("GlowB");
	GlowB.SetBoundaries(0.f, 255.f);
	GlowB.SetValue(0.f);
	ControlGroup.PlaceLabledControl("Glow Blue", this, &GlowB);
	...
	ControlGroup.PlaceLabledControl("Chams Visible Red", this, &ChamsVisRed);

	ChamsVisGreen.SetFileId("chamsvisgreen");
	ChamsVisGreen.SetBoundaries(0.f, 255.f);
	ChamsVisGreen.SetValue(255.f);
	ControlGroup.PlaceLabledControl("Chams Visible Green", this, &ChamsVisGreen);

	ChamsVisBlue.SetFileId("chamsvisblue");
	ChamsVisBlue.SetBoundaries(0.f, 255.f);
	ChamsVisBlue.SetValue(255.f);
	ControlGroup.PlaceLabledControl("Chams Visible Blue", this, &ChamsVisBlue);
	...
	ControlGroup.PlaceLabledControl("Chams not Visible Red", this, &ChamsNotVisRed);

	ChamsNotVisGreen.SetFileId("chamsnotvisgreen");
	ChamsNotVisGreen.SetBoundaries(0.f, 255.f);
	ChamsNotVisGreen.SetValue(255.f);
	ControlGroup.PlaceLabledControl("Chams not Visible Green", this, &ChamsNotVisGreen);

	ChamsNotVisBlue.SetFileId("chamsnotvisblue");
	ChamsNotVisBlue.SetBoundaries(0.f, 255.f);
	ChamsNotVisBlue.SetValue(255.f);
	ControlGroup.PlaceLabledControl("Chams not Visible Blue", this, &ChamsNotVisBlue);
